...
var Jethe = (function () {
    ...
    Object.defineProperty(Jethe.prototype, "port", {
        get: function () {
    ...
    Jethe.prototype.get = function (url, cb) {
        this.routes.push(new Route(url, cb));
    };
    Jethe.prototype.addFileDir = function (pfx, dir) {
        this.dirs.push(new FileDir(pfx, dir));
    };
    Jethe.prototype.listen = function (port) {
        this.srv.listen(port);
    };
    Jethe.prototype.handle = function (req, rsp) {
